    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            if (ModelState.IsValid && WebSecurity.Login(model.UserName, model.Password, persistCookie: model.RememberMe))
            {
                ...
                while (i < r.Length)
                {
                    Session.Add("practiceId", user.PracticeId.ToString());
                    if (r[i] == "User")
                    {
                        return RedirectToAction("Index", "Client", new { practiceId = user.PracticeId.ToString() });
                    }
                    if (r[i] == "Admin")
                    {
                        return RedirectToAction("Index", "Setup", new { practiceId = user.PracticeId.ToString() });
                    }
                    i++;
                }
